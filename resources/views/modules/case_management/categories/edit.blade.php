...
@section('breadcrumbs', 'Case Management / Categories / Edit')

@section('content')
<form action="{{ route('cases.categories.update', $category) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        @php $selected = old('required_fields', $category->required_fields ?? []); @endphp
